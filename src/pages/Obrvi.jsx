...
<section style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
  <img src="/pmu1.jpg" style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="" />
  <div style={{
  ...
  <div style={{
    ...
    <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 88, fontWeight: 300, lineHeight: 1, margin: 0, color: '#ffffff' }}>
      Permanentni <em style={{ color: 'var(--color-primary-light)' }}>make-up</em>
    </h1>
  </div>
</section>
  ...
  <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 48, fontWeight: 300, lineHeight: 1.1, margin: '0 0 32px', color: '#fff' }}>
            prvi del <em style={{ color: 'var(--color-primary-light)' }}> ... </em>
          </h2>
  ...
  <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 48, fontWeight: 300, lineHeight: 1.1, margin: '0 0 32px', color: '#fff' }}>
            drugi del <em style={{ color: 'var(--color-primary-light)' }}> ... </em>
          </h2>
      ...
      {/* PARALLAX SLIKA 2 */}
      <div className="parallax-img" style={{ backgroundImage: 'url(/tatu3.jpg)' }} />
  ...
  <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 48, fontWeight: 300, lineHeight: 1.1, margin: '0 0 32px', color: '#fff' }}>
            tretji del <em style={{ color: 'var(--color-primary-light)' }}> ... </em>
          </h2>
          <p style={{ fontSize: 15, lineHeight: 1.9, color: 'rgba(255,255,255,0.65)', margin: 0 }}>
            ...</p>
        </div>
